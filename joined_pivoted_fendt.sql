...
AVG(IF(unn.type = 'WheelBasedVehicleSpeed', unn.value, null)) SpeedGearbox_km_h,
...
AVG(IF(unn.type = 'LoadAtCurrSpeed', unn.value, null)) EngineLoad,
...
AVG(IF(unn.type = 'EngineSpeed', unn.value, null)) Engine_rpm,
AVG(IF(unn.type = 'CoolantTemperature', unn.value, null)) TempCoolant_C,
...
AVG(IF(unn.type = 'FuelRate', unn.value, null)) FuelConsumption_l_h,
AVG(IF(unn.type = 'TOTAL_VEHICLE_HOURS', unn.value, null)) TotalWorkingHours,
...
AVG(IF(unn.type = 'DiffLockState', unn.value, null)) DifferentialLockStatus
from unn
