...
prevnext as (
  select unit_id, datetime, gpsLongitude, 
...
intervals as (
  select unit_id, datetime as startDateTime, running as startState, 
...
select unit_id, startDateTime, StopDateTime
from intervals
where startState = 'start' and stopState = 'stop'
